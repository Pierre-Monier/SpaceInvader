...
var Level = /** @class */ (function () {
    ...
    Level.prototype.keySpace = function () {
        ...
        if (this.laser.length < 1 || this.checkEvilLaser() && this.laser.length <= 3) {
            ...
            setTimeout(function () { _this.spam_state = null; }, 1250);
        }
    };
    Level.prototype.checkEvilLaser = function () {
        for (var i = 0; i < this.laser.length; i++) {
    ...
    Level.prototype.getLevelScore = function () { return this.score; };
    Level.prototype.getLevelState = function () { return this.state; };
    Level.prototype.getMusic = function () { return this.music; };
    Level.prototype.getSpam = function () { return this.spam_state; };
    return Level;
}());
